...
with DAG(
    ...
    my_own_operator = MyOwnOperator(
        task_id="Test_MyOwnOperator", dag=dag, connection="mysql_default", param="param"
    )

    # nes_operator = NesOperator(
    #     task_id="nes_task",
    #     input_nb="https://github.com/sktaiflow/notebooks/blob/master/test/skt_version_test.ipynb",
    # )

    extract_task >> transform_task >> load_task >> my_own_operator
